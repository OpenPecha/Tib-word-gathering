...
from TibWordGathering.segpos_kang_and_eteng import process_file


def test_segpos_kang_teng():
    """
    ...
    valid_output_path = (
        "tests/data/actual/segpos_kang_and_eteng_data.json"  # Path to save valid data
    )
