...
from TibWordGathering.evaluation_tib_word import read_and_process_tibetan_data
...
def test_evaluate_tib_word():
    ...
    valid_output_path = (
        "tests/data/actual/evaluate_data.json"  # Path to save valid data
    )
